    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-light d-flex">
                <h4 class="ml-auto">Alumno</h4>
                <a href="<?= site_url('Alumno/agregarAlumno') ?>" class="btn btn-primary ml-auto"  title="Agregar Alumno"><i class="fas fa-plus"></i> &nbsp; Agregar Alumno</a>
            </div>
            <div class="card-body">
                ...
                <fieldset class="border p-2">
                    ...
                    <?= form_open_multipart('Alumno', 'id="formbusqueda"') ?>
                    <div class="row">                        
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <a  href="<?= site_url('Alumno/AlumnoPDF') ?>"class="btn btn-info" title="Imprimir" target="_blank" ><i class="fa fa-print">GENERAR LISTADO </i></a>
                            </div>
                        </div>
                    </div>
                    <?= form_close() ?>
                                        ...
                                        <td>
                                            <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <a  href="<?= site_url('Alumno/agregarAlumno/' . $Alumnos->IdAlumno) ?>" class="btn btn-primary" title="Editar"><i class="far fa-edit"></i></a>                                                
                                                   <!-- <a  href="<= site_url('clientes/verCliente/' . $Alumnos->IdAlumno . '/cliente') ?>"class="btn btn-secondary" title="Detalles"><i class="fa fa-search-plus"></i></a> -->
                                                    <a  href="<?= site_url('Alumno/eliminarAlumno/' . $Alumnos->IdAlumno) ?>"class="btn btn-danger" title="Borrar" onclick="return confirm('Esta seguro de Eliminar el Alumno???')"><i class="fas fa-trash"></i></a>
                                                   <!-- <= anchor(site_url('facturacion/nuevoPagoCliente/'.$Alumnos->IdAlumno), '<i class="fa fa-money-bill-alt"></i>',' class="btn btn-secondary" title="Realizar Pago"') ?> -->
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
