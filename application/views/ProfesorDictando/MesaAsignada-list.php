        ...
        <div class="card">
            <div class="card-body">
                <fieldset class="border p-2">
                    ...
                    <?= form_open_multipart('ProfesorDictando/MesaAsignadas', 'id="formbusqueda"') ?>
                    <div class="row">                        
                        <div class="col-md-6">
                ...
                <div class="table-responsive mt-3">
                    <h3>Listado de Mesas Asignadas</h3>
                    <table class="table" id="tabla_clientes">
                        ...
                        <tbody>
                            <?php
                            if (count($MesaAsignadas) > 0) {
                                foreach ($MesaAsignadas as $MesaAsignada):
                                    ?>
                                    <tr >
                                        <td><?= $MesaAsignada->FechaMesa?></td>
                                        <td><?= $MesaAsignada->NumeroLibro ?></td>
                                        <td><?= $MesaAsignada->Follio ?></td>
                                        <td><?= $MesaAsignada->IdCarrera->Nombre?></td>
                                        <td><?= $MesaAsignada->IdMateria->Nombre ?></td>
                                        <td>
                                            <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                <a href="<?= site_url('ProfesorDictando/ListaAlumnoMesa/'.$MesaAsignada->IdMesa) ?>" class="btn btn-primary" title="Conocer los alumnnos"><i class="fas fa-file-signature"></i></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                echo'<tr><td colspan="6" class="alert alert-danger">No se encontraton resultados</td></tr>';
                            ?>
                        </tbody>
                    </table>
                </div>
