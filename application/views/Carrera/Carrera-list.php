    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-light d-flex">
                <h4 class="ml-auto">Carrera</h4>
                <a href="<?= site_url('Carrera/agregarCarrera') ?>" class="btn btn-primary ml-auto"  title="Agregar Carrera"><i class="fas fa-plus"></i> &nbsp; Agregar Carrera</a>
            </div>
            <div class="card-body">
                ...
                <fieldset class="border p-2">
                    ...
                    <?= form_open_multipart('Carrera', 'id="formbusqueda"') ?>
                    <div class="row">                        
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <a  href="<?= site_url('Carrera/CarreraPDF') ?>"class="btn btn-info" title="Imprimir" target="_blank" ><i class="fa fa-print">GENERAR LISTADO </i></a>
                            </div>
                        </div>
                    </div>
                    <?= form_close() ?>
                    ...
                    <table class="table" id="tabla_clientes">
                        ...
                        <tbody>
                            ...
                            if (count($Carrera) > 0) {
                                        ...
                                        <td>
                                            <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <a  href="<?= site_url('Carrera/agregarCarrera/' . $Carreras->IdCarrera) ?>" class="btn btn-primary" title="Editar"><i class="far fa-edit"></i></a>                                                
                                                   <!-- <a  href="<= site_url('clientes/verCliente/' . $Carreras->IdCarrera . '/cliente') ?>"class="btn btn-secondary" title="Detalles"><i class="fa fa-search-plus"></i></a> -->
                                                    <a  href="<?= site_url('Carrera/eliminarCarrera/' . $Carreras->IdCarrera) ?>"class="btn btn-danger" title="Borrar" onclick="return confirm('Esta seguro de Eliminar el Carrera???')"><i class="fas fa-trash"></i></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                echo'<tr><td colspan="3" class="alert alert-danger">No se encontraton resultados</td></tr>';
                            ?>
                        </tbody>
                    </table>
                </div>
