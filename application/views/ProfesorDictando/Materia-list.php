        ...
        <div class="card">
            <div class="card-body">
                <fieldset class="border p-2">
                    ...
                    <?= form_open_multipart('ProfesorDictando/Materias', 'id="formbusqueda"') ?>
                    <div class="row">                        
                        <div class="col-md-6">
                        ...
                        <tbody>
                            ...
                            if (count($materia) > 0) {
                                foreach ($materia as $materias):
                                    ?>
                                    <tr >
                                        <td><?= $materias->IdMateria->Nombre?></td>
                                        <td><?= $materias->Anio ?></td>
                                        <td><?= $materias->FechaFin ?></td>
                                        <td> hola<?php //($materias->FechaFin>date('Y-m-d'))? echo "Inactivo": echo "Activo"  ?></td>
                                        <td>
                                            <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <a href="<?= site_url('ProfesorDictando/ListaAlumno/'.$materias->IdCurso) ?>" class="btn btn-primary" title="Conocer los alumnnos"><i class="fas fa-file-signature"></i></a>                          
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
