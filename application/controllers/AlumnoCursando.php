...
class AlumnoCursando extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('AlumnoCursando_model');
    ...
    public function Notas() {
        ...
        $dato['Alumno'] = $Alumnos;
         $data["content"] = $this->load->view("AlumnoCursando/Nota-list", $dato, TRUE); 
   ...
   public function InscripcionMaterias() {
    ...
    $dato['Alumno'] = $Alumnos;
     $data["content"] = $this->load->view("AlumnoCursando/InscripcionMateria-list", $dato, TRUE); 
    $this->load->view("principal", $data);
}
public function FechaExamen() {
    ...
    $dato['Alumno'] = $Alumnos;
     $data["content"] = $this->load->view("AlumnoCursando/FechaExamen-list", $dato, TRUE); 
    $this->load->view("principal", $data);
}
