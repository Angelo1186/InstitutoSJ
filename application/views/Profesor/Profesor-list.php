    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-light d-flex">
                <h4 class="ml-auto">Profesor</h4>
                <a href="<?= site_url('Profesor/agregarProfesor') ?>" class="btn btn-primary ml-auto"  title="Agregar Profesor"><i class="fas fa-plus"></i> &nbsp; Agregar Profesor</a>
            </div>
            <div class="card-body">
                ...
                <fieldset class="border p-2">
                    ...
                    <?= form_open_multipart('Profesor', 'id="formbusqueda"') ?>
                    <div class="row">                        
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <a  href="<?= site_url('Profesor/ProfesorPDF') ?>"class="btn btn-info" title="Imprimir" target="_blank" ><i class="fa fa-print">GENERAR LISTADO </i></a>
                            </div>
                        </div>
                    </div>
                    <?= form_close() ?>
                        ...
                        <tbody>
                            ...
                            if (count($profesor) > 0) {
                                foreach ($profesor as $profesors):
                                    ?>
                                    <tr >
                                        <td><?= $profesors->Legajo?></td>
                                        <td><?= $profesors->Nombre ?></td>
                                        <td><?= $profesors->Apellido ?></td>
                                        <td><?= $profesors->Dni ?></td>
                                        <td><?= $profesors->Telefono?></td>
                                        <td><?= $profesors->IdBarrio->Nombre?></td>
                                        <td><?= $profesors->Domicilio?></td>
                                        <td><?= $profesors->Email?></td>
                                        <td>
                                            <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <a  href="<?= site_url('Profesor/agregarProfesor/' . $profesors->IdProfesor) ?>" class="btn btn-primary" title="Editar"><i class="far fa-edit"></i></a>                                                
                                                   <!-- <a  href="<= site_url('clientes/verCliente/' . $profesors->IdProfesor . '/cliente') ?>"class="btn btn-secondary" title="Detalles"><i class="fa fa-search-plus"></i></a> -->
                                                    <a  href="<?= site_url('Profesor/eliminarProfesor/' . $profesors->IdProfesor) ?>"class="btn btn-danger" title="Borrar" onclick="return confirm('Esta seguro de Eliminar el Profesor???')"><i class="fas fa-trash"></i></a>
                                                   <!-- <= anchor(site_url('facturacion/nuevoPagoCliente/'.$profesors->IdProfesor), '<i class="fa fa-money-bill-alt"></i>',' class="btn btn-secondary" title="Realizar Pago"') ?> -->
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
