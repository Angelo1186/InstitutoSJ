    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-light d-flex">
                <h4 class="ml-auto">Correlatividad</h4>
                <a href="<?= site_url('Correlatividad/agregarCorrelatividad') ?>" class="btn btn-primary ml-auto"  title="Agregar Correlatividad"><i class="fas fa-plus"></i> &nbsp; Agregar Correlatividad</a>
            </div>
            <div class="card-body">
                ...
                <fieldset class="border p-2">
                    ...
                    <?= form_open_multipart('Correlatividad', 'id="formbusqueda"') ?>
                    <div class="row">                        
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <a  href="<?= site_url('Correlatividad/CorrelatividadPDF') ?>"class="btn btn-info" title="Imprimir" target="_blank" ><i class="fa fa-print">GENERAR LISTADO </i></a>
                            </div>
                        </div>
                    </div>
                    <?= form_close() ?>
                ...
                <div class="table-responsive mt-3">
                    <h3>Listado de las Correlatividades</h3>
                    <table class="table" id="tabla_clientes">
                        ...
                        <tbody>
                            ...
                            if (count($Correlatividad) > 0) {
                                        ...
                                        <td>
                                            <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <a  href="<?= site_url('Correlatividad/agregarCorrelatividad/' . $Correlatividads->IdCorrelatividad) ?>" class="btn btn-primary" title="Editar"><i class="far fa-edit"></i></a>                                                
                                                   <!-- <a  href="<= site_url('clientes/verCliente/' . $Correlatividads->IdCorrelatividad . '/cliente') ?>"class="btn btn-secondary" title="Detalles"><i class="fa fa-search-plus"></i></a> -->
                                                    <a  href="<?= site_url('Correlatividad/eliminarCorrelatividad/' . $Correlatividads->IdCorrelatividad) ?>"class="btn btn-danger" title="Borrar" onclick="return confirm('Esta seguro de Eliminar el Correlatividad???')"><i class="fas fa-trash"></i></a>
                                                   <!-- <= anchor(site_url('facturacion/nuevoPagoCliente/'.$Correlatividads->IdCorrelatividad), '<i class="fa fa-money-bill-alt"></i>',' class="btn btn-secondary" title="Realizar Pago"') ?> -->
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                echo'<tr><td colspan="4" class="alert alert-danger">No se encontraton resultados</td></tr>';
                            ?>
                        </tbody>
                    </table>
                </div>
